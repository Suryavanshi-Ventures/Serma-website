...
const Modal = ({ position, isOpen, onClose, children, modalTitle, width }) => {
  ...
  return (
    <div className={ModalClass} onClick={onClose}>
      ...
      <div
        className={`modal-container bg-white  ${width}  relative max-sm:mx-5 mx-auto rounded-lg shadow-lg z-50 overflow-y-auto`}
      ...
      >
        <div className={`flex justify-${position} items-center px-5 py-4`}>
          ...
          <button
            onClick={onClose}
            className="modal-close absolute top-8 right-5 justify-end w text-gray-500 hover:text-gray-700  hover:bg-[#efeeee] rounded-full transition-all duration-[0.3s]"
          >
            <svg
              width="18"
              height="18"
