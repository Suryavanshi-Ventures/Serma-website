  ...
  return (
    <div>
      <div>
        ...
        <div className="text-center responsive-Text text-gray my-8 md:space-y-3 ">
          <p>
            The Sports and Entertainment Risk Management Alliance (SERMA) is the
            first risk management association devoted{" "}
          </p>
          <p>entirely to the sports and entertainment industries.</p>{" "}
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 grid-rows-1 gap-x-3 gap-y-1  ">
          <div className=" rounded-2xl shadow-xl flex max-sm:justify-center  max-sm:p-0  md:p-3 ">
            <div className=" ">
              <div className="">
                <Image
                  src="/upcoming-event/image-1.png"
                  height={225}
                  width={396}
                />
              </div>
              <div className="px-4">
                <div className="flex md:gap-5 gap-2  ">
                  ...
                  >
                    <g clip-path="url(#clip0_867_9341)">
                      <path
                  ...
                  <div className="text-gray text-sm">
                    March 19, 2024 4:00 PM (MDT){" "}
                  </div>
                </div>
                <div className="text-lg my-2">Virtual</div>
                <div className="font-semibold text-[#525971] ">
                  SERMA® Webinar: Treating Elite Athlete Injuries Webinar
                </div>
          ...
          <div className=" rounded-2xl shadow-xl flex max-sm:justify-center  max-sm:p-0  md:p-3 ">
            <div className=" ">
              <div className="">
                <Image
                  src="/upcoming-event/image-2.png"
                  height={225}
                  width={396}
                />
              </div>
          ...
          <div className=" rounded-2xl shadow-xl flex max-sm:justify-center  max-sm:p-0  md:p-3 ">
            <div className=" ">
              <div className="">
                <Image
                  src="/upcoming-event/image-3.png"
                  height={225}
                  width={396}
                />
              </div>
        ...
        <div className="my-6 md:my-8 flex justify-center">
          <div
            ...
            className="flex justify-center items-center gap-2 border border-gray hover:bg-primary cursor-pointer transition duration-300   hover:text-white rounded-full px-5 py-2"
          >
