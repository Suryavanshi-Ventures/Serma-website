          ...
          <div>
            <div className="flex md:justify-between  max-md:flex-col ">
              ...
              <div className="max-md:w-full  ">
                <div className="p-4 lg:px-8 lg:py-4  bg-white md:w-[350px] text-[20px] shadow-[-5px_6px_40px_0px_#00000024] rounded-2xl">
        ...
        >
          <div className="px-[10px]">
            ...
            <div className="text-[14px] md:text-sm text-gray my-4 px-3">
              ...
              {formatDate(upcomingEvents?.start_date_time)} -{" "}
