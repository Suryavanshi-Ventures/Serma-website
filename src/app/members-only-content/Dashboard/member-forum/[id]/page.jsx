      ...
      <div className="w-full my-4 bg-[#F8F8F8] shadow-sm rounded-xl p-6 space-y-4 overflow-auto">
        <div className="space-y-4">
          <div className="flex justify-between">
           ...
           {FilteredTopic?.data?.user_id == userLoginId ?  <div className="space-x-4">
                <span className="flex gap-4">
                  {/* -----------------------------edit------------------------------------ */}
                  <div className="border cursor-pointer transition duration-300 border-[#C8C8C8] hover:border-primary p-[10px] rounded-full">
                    <svg
                      width="16"
                      height="15"
                      viewBox="0 0 16 15"
