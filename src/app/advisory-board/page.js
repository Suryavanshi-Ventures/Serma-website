...
function AdvisoryBoard() {
  const advisory_board_members = [
    ...
    },
    {
      ...
      department: "VP, Assistant General Counsel ",
    },
    ...
    },
    {
      id: 8,
      name: "Mary Gibson",
      position: "VP, Enterprise Risk Management & Corporate Counsel",
      department: "Major League Soccer",
    },
    {
      id: 9,
      name: "Warren Harper",
          ...
          <div className="flex flex-col md:flex-row bg-[#F0F0F0] p-4 bg-opacity-50 rounded-2xl">
            ...
            <div className="flex-1 md:ml-10">
              ...
              <div className="text-[14px]  xl:text-lg text-black mt-4 leading-loose">
                ...
                (starring Barack Obama, Bill Murray, Mike Ditka) and John Wayne
                Gacy: Defending a Monster. Rich was also the lead producer for
                the very successful Las Vegas production Renegades, starring Jim
                McMahon, Terrell Owens and Jose Canseco and is involved in other
